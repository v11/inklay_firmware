...
// GPIO Pins
const gpio_num_t pinRSE = GPIO_NUM_2; // Digital Input Bluetooth Button
...
const char *timezone;
const char *timezoneLocation;
String timezoneStr;
String timezoneLocationStr;
...
void setInterrupt() {
    ...
    attachInterrupt(pinRSE, reset, HIGH);
}
...
void getDeviceConfig(const char *host) {
    ...
    const char *timezoneLocationTmp = doc["timezoneLocation"];

    // Assign Timezone
    timezone = timezoneTmp;
    timezoneStr = timezoneTmp;
    timezoneLocation = timezoneLocationTmp;
    timezoneLocationStr = timezoneLocationTmp;
    ...
    Serial.print("received: timezone location: ");
    Serial.println(timezoneLocationTmp);
    Serial.print("received: deep sleep in seconds: ");
...
void sendDeviceStats(const char *host) {
    ...
    doc["timezoneLocation"] = timezoneLocationStr;
    doc["timestamp"] = timestamp;
    doc["nextUpdate"] = timestamp + deepSleepInSeconds;
    ...
    Serial.println(clientDisplayType);
    Serial.print("sent: timezone: ");
    Serial.println(timezoneStr);
    Serial.print("sent: timezone location: ");
    Serial.println(timezoneLocationStr);
    Serial.print("sent: last update: ");
    Serial.println(timestamp);
    Serial.print("sent: next update: ");
    Serial.println(timestamp + deepSleepInSeconds);
...
void setDeepSleep(DeepSleepMode deepSleepMode) {
    ...
    esp_sleep_enable_ext0_wakeup(pinRSE, 1); // 1 = High, 0 = Low
